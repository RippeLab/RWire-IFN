...
getBackgroundCoAccessibility <- function(
  ...
  ### Select most distant (randomly distributed) cells in low dimensional embedding for unique cell aggregation
  ...
  ### Select every cell only once for unique cell aggregation
  if(cellAggregation == "unique"){
