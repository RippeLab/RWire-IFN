  ...
  if(!is.null(loops)){
    ...
    if(testDim){
      ...
      p <- ggplot(data = data.frame(loopO), aes(x = x, y = y, group = id, color = value)) +
        ...
        ylab("ACR") + 
        coord_cartesian(ylim = c(valueMax_ACR,0)) +
        ###
        scale_x_continuous(limits = c(start(region), end(region)), expand = c(0,0)) +
...
### Copied from https://github.com/GreenleafLab/ArchR/blob/968e4421ce7187a8ac7ea1cf6077412126876d5f/R/ArchRBrowser.R on 15/10/2021